...
- [V1](https://youtu.be/91XfkLal3WI) 
- [V2](https://youtu.be/nyWn54zRttQ)
- [V3](https://youtu.be/pSEGc4U7IbY)
- [V4](https://youtu.be/nMwR9jqCRTI)

## What is Job DSL in Jenkins?

Jenkins Job DSL was created to make it easier to manage jobs.

- When jobs grow, maintaining becomes difficult and a lot of work
    - Jenkins Job DSL plugin solves this problem with a lot of extra benefits:
        - Version Control
        - History
        - Audit Log
...
- Groovy is a scripting language for the java platform, similar to java syntax but it runs in JVM (Java Virtual Machine).
